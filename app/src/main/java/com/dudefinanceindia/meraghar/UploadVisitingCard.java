...
public class UploadVisitingCard extends Fragment {
    ...
    private View view;
    private ImageView visiting_card_ib;
    ...
    private final static String IMAGE_NAME = "visiting_card.jpg";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        visiting_card_ib = view.findViewById(R.id.ld_select_visiting_card_ib);
        upload_b = view.findViewById(R.id.ld_upload_b);
        loading = view.findViewById(R.id.ld_spin_kit);
        loading1 = view.findViewById(R.id.ld_spin_kit_1);
        delete_ib = view.findViewById(R.id.ld_delete_ib);
        back_ib = view.findViewById(R.id.ld_back_ib);
        numberProgressBar = view.findViewById(R.id.ld_number_progress);
        ...
        back_ib.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Fragment fragment = Objects.requireNonNull(getActivity()).getSupportFragmentManager().findFragmentByTag("visiting_card");
                if(fragment != null)
        ...
        visiting_card_ib.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                selectImageToUpload();
            }
    ...
    private void checkIfImageUploaded() {
        ...
        databaseReference.child(USER_PROFILES).child(uid).child(IMAGES)
                .child("visiting_card").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!TextUtils.isEmpty(url)){
                    Picasso.with(getActivity())
                            .load(url)
                            .into(visiting_card_ib);
                    delete_ib.setVisibility(View.VISIBLE);
                    dismiss1();
                }
                else {
                    visiting_card_ib.setBackgroundResource(R.drawable.ic_upload_image);
                    dismiss1();
                }
    ...
    private void deleteImage() {
        final String uid = Objects.requireNonNull(mAuth.getCurrentUser()).getUid();
        databaseReference.child(USER_PROFILES).child(uid).child(IMAGES)
                .child("visiting_card").setValue(null).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            ...
            if (resultCode == RESULT_OK) {
              ...
              //  File actualImage = FileUtils.getFile(getActivity(), ImageFilePath);
                //if (getExtension(actualImage)){
                    visiting_card_ib.setBackground(null);
                    Picasso.with(getActivity())
                            .load(ImageFilePath)
                            .into(visiting_card_ib);
        ...
        try{
            if (ImageFilePath != null) {
                ...
                final StorageReference imageStorageReference = storageReference.child(USER_PROFILES).child(uid)
                       .child(IMAGES).child("visiting_card").child(IMAGE_NAME);
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        databaseReference.child(USER_PROFILES).child(uid).child(IMAGES)
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                showMessage.successMessage("Success", "Visiting Card Image Uploaded Successfully");
                                                dismiss();
